As you follow the instructions in [the README](README.md), you'll be asked to replace the contents of your project's `/spec/model/user_spec.rb` with the following Ruby code:
